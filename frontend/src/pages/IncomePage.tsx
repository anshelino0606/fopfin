...
const IncomeItem = styled.div`
  background: ${props => props.theme.mode === 'dark' ? 'var(--background-dark)' : '#fff'};  background: ${props => props.theme.mode === 'dark' ? '#374578' : '#fff'};
  border-radius: 8px;
  padding: 16px;
  display: flex;
    ...
    <PageWrapper>
      <PageContainer>
        <Header>
          ...
          <HeaderTitle>
            <IncomeInput>Надходження</IncomeInput>
          ...
          <ModalOverlay>
            <ModalContent>
              ...
              <AmountInput
                ...
                error={amountError}
              />
              {amountError && <div style={{ color: '#f44336' }}>Будь ласка, введіть суму</div>}
              <CategorySelect
              ...
              {categoryError && <div style={{ color: '#f44336' }}>Будь ласка, виберіть категорію</div>}
